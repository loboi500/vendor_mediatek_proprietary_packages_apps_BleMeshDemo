...
public class MessageNetIndexAdapter extends BaseAdapter implements OnClickListener {

    private static final String TAG = "MessageNetIndexAdapter";
    ...
    public MessageNetIndexAdapter(Context context,List<String> datas) {
        Log.i(TAG,"MessageNetIndexAdapter datas size = " + datas.size());
