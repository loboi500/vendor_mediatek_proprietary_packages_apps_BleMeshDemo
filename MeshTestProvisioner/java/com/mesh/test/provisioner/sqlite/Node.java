...
public class Node {
    ...
    private int mFSStatus = 0;
    private int mFSContOff = 0;
    private int mFSMaxContOff = 0;
    private float mFSOnCostTime = 0;
    ...
    private boolean mCmdAddFriDev = false; //whether add friendship device to Node list by adb command
    private String mFriDevName; //if mCmdAddFriDev is true , ui show mFriDevName , if mCmdAddFriDev is false, ui show uuid
    ...
    public int getFSStatus() {
        return this.mFSStatus;
    }

    public void setFSStatus(int mFSStatus) {
        this.mFSStatus = mFSStatus;
    }

    public void setFSContOff(int mFSContOff) {
        this.mFSContOff = mFSContOff;
    }

    public int getFSContOff() {
        return this.mFSContOff;
    }

    public void setFSMaxContOff(int mFSMaxContOff) {
        this.mFSMaxContOff = mFSMaxContOff;
    }

    public int getFSMaxContOff() {
        return this.mFSMaxContOff;
    }

    public void setFSOnCostTime(float mFSOnCostTime) {
        this.mFSOnCostTime = mFSOnCostTime;
    }

    public float getFSOnCostTime() {
        return this.mFSOnCostTime;
    }
    ...
    public void setCmdAddFriDev(boolean mCmdAddFriDev) {
        this.mCmdAddFriDev = mCmdAddFriDev;
    }

    public boolean getCmdAddFriDev() {
        return this.mCmdAddFriDev;
    }

    public void setFriDevName(String mFriDevName) {
        this.mFriDevName = mFriDevName;
    }

    public String getFriDevName() {
        return this.mFriDevName;
    }
    ...
    public void addSupportedRXMsg(int elementAddr, long modelID, Model model)
    {
        switch ((int)modelID) {
            ...
            case MeshConstants.MESH_MODEL_SIG_MODEL_ID_LIGHT_LIGHTNESS_SERVER: {
                mSupportedMsgList.add(new MeshMessage(MeshConstants.MESH_MSG_LIGHT_LIGHTNESS_GET, elementAddr, "Light Lightness Get(" + MeshUtils.decimalToHexString("%04X", elementAddr) + ")", model));
                mSupportedMsgList.add(new MeshMessage(MeshConstants.MESH_MSG_LIGHT_LIGHTNESS_SET, elementAddr, "Light Lightness Set(" + MeshUtils.decimalToHexString("%04X", elementAddr) + ")", model));
                mSupportedMsgList.add(new MeshMessage(MeshConstants.MESH_MSG_LIGHT_LIGHTNESS_SET_UNACKNOWLEDGED, elementAddr, "Light Lightness Set Unack(" + MeshUtils.decimalToHexString("%04X", elementAddr) + ")", model));
                ...
                mSupportedMsgList.add(new MeshMessage(MeshConstants.MESH_MSG_LIGHT_LIGHTNESS_RANGE_GET, elementAddr, "Light Lightness Range Get(" + MeshUtils.decimalToHexString("%04X", elementAddr) + ")", model));
            ...
            case MeshConstants.MESH_MODEL_SIG_MODEL_ID_LIGHT_CTL_SERVER: {
                mSupportedMsgList.add(new MeshMessage(MeshConstants.MESH_MSG_LIGHT_CTL_GET, elementAddr, "Light CTL Get(" + MeshUtils.decimalToHexString("%04X", elementAddr) + ")", model));
                mSupportedMsgList.add(new MeshMessage(MeshConstants.MESH_MSG_LIGHT_CTL_SET, elementAddr, "Light CTL Set(" + MeshUtils.decimalToHexString("%04X", elementAddr) + ")", model));
                mSupportedMsgList.add(new MeshMessage(MeshConstants.MESH_MSG_LIGHT_CTL_SET_UNACKNOWLEDGED, elementAddr, "Light CTL Set Unack(" + MeshUtils.decimalToHexString("%04X", elementAddr) + ")", model));
                //mSupportedMsgList.add(new MeshMessage(MeshConstants.MESH_MSG_LIGHT_CTL_TEMPERATURE_GET, elementAddr, "Light CTL Temperature Get(" + MeshUtils.decimalToHexString("%04X", elementAddr) + ")", model));
                //mSupportedMsgList.add(new MeshMessage(MeshConstants.MESH_MSG_LIGHT_CTL_TEMPERATURE_SET, elementAddr, "Light CTL Temp Set(" + MeshUtils.decimalToHexString("%04X", elementAddr) + ")", model));
                //mSupportedMsgList.add(new MeshMessage(MeshConstants.MESH_MSG_LIGHT_CTL_TEMPERATURE_SET_UNACKNOWLEDGED, elementAddr, "Light CTL Temperature Set Unack(" + MeshUtils.decimalToHexString("%04X", elementAddr) + ")", model));
                //mSupportedMsgList.add(new MeshMessage(MeshConstants.MESH_MSG_LIGHT_CTL_DEFAULT_GET, elementAddr, "Light CTL Default Get(" + MeshUtils.decimalToHexString("%04X", elementAddr) + ")", model));
                ...
                mSupportedMsgList.add(new MeshMessage(MeshConstants.MESH_MSG_LIGHT_CTL_TEMPERATURE_RANGE_GET, elementAddr, "Light CTL Temp Range Get(" + MeshUtils.decimalToHexString("%04X", elementAddr) + ")", model));
                //mSupportedMsgList.add(new MeshMessage(MeshConstants.MESH_MSG_LIGHT_CTL_TEMPERATURE_RANGE_SET, elementAddr, "Light CTL Temperature Range Set("+elementAddr+")", model));
                //mSupportedMsgList.add(new MeshMessage(MeshConstants.MESH_MSG_LIGHT_CTL_TEMPERATURE_RANGE_SET_UNACKNOWLEDGED, elementAddr, "Light CTL Temperature Range Set Unack("+elementAddr+")", model));
                break;
            }
